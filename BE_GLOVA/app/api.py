...
import json
import re
from schemas import UserQuestion, ClovaResponse, CalendarResponse, BadgeRequest, BadgeSchema
...
from schemas import UserSchema, TokenSchema, BookSchema, SessionSchema, RecommendedBookSchema, BadgeSchema, ReviewSchema, UserQuestionSchema, ClovaAnswerSchema
...
async def save_books(calendarResponse: CalendarResponse):
    try:
        ...
        calendar_data.append(calendarResponse.model_dump())
